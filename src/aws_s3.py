...
def download_file(s3_file_path, bucket, save_as=None):
    ...
    s3.download_file(
        bucket, s3_file_path, save_as, Callback=ProgressPercentage(file_name)
    )
...
if __name__ == "__main__":
    bucket = "bio-tech-data-bruvio"
    name1 = "assay_results.csv"
    name2 = "compound_ic50.csv"
    name3 = "assay_results.csv"
    ...
    # list_buckets()
    file_name = "/".join((folder, name1))
    upload_file(file_name, bucket, object_name=name1)
    file_name = "/".join((folder, name2))
    upload_file(file_name, bucket, object_name=name2)
    file_name = "/".join((folder, name3))
    upload_file(file_name, bucket, object_name=name3)
